package com.yijian.clubmodule.jpush.bean;
...
public class PushInfoBean {
    ...
    public Boolean getHasNewJiedaiPush() {
        return hasNewJiedaiPush;
    }

    public void setHasNewJiedaiPush(Boolean hasNewJiedaiPush) {
        this.hasNewJiedaiPush = hasNewJiedaiPush;
    }

    public Boolean getHasNewYueKePush() {
        return hasNewYueKePush;
    }

    public void setHasNewYueKePush(Boolean hasNewYueKePush) {
        this.hasNewYueKePush = hasNewYueKePush;
    }
}
