 ...
 */
class HuiFangHistoryAdapter(private val context: Context, private var mHuiFangInfoList: List<HuiFangInfo>?) : RecyclerView.Adapter<HuiFangHistoryAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HuiFangHistoryAdapter.ViewHolder {
