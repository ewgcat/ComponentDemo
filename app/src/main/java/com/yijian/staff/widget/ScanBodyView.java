...
public class ScanBodyView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Rect   destRect1  = new Rect(left,  top, (int) (measuredWidth/ratio_bottom)+left, top+scanning_height);  //bitmap放置的目标区域
        Rect   destRect2  = new Rect(left, top, (int) (measuredWidth/ratio_upper)+left, (int) (top+scanning_height*(position_y/100.0)));//bitmap放置的目标区域
