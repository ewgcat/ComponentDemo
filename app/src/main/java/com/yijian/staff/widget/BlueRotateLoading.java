...
public class BlueRotateLoading extends View {
    ...
    public BlueRotateLoading(Context context) {
        super(context);
        initView(context, null);
    }

    public BlueRotateLoading(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public BlueRotateLoading(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        if (null != attrs) {
            ...
            color = typedArray.getColor(R.styleable.RotateLoading_loading_color, getResources().getColor(R.color.blue));
