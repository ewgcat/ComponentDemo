 ...
 */
public class AddViperRankListAdatper extends RecyclerView.Adapter<AddViperRankListAdatper.ViewHolder> {
    private List<RankBean> rankBeanList;
    private Context context;

    public AddViperRankListAdatper(Context context, List<RankBean> rankBeanList) {
