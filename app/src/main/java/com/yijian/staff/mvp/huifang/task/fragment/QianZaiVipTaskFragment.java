...
public class QianZaiVipTaskFragment extends CommonHuiFangTaskFragment {
    ...
    public QianZaiVipTaskFragment() {
        super();
        viewId = R.layout.fragment_qian_zai_vip_list;
    }

    public QianZaiVipTaskFragment(Context context, int type) {
