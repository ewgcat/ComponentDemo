...
public class  SportTestActivity extends MvcBaseActivity {
    ...
    private final String tag1 = "com.yijian.workspace.workspace.sport.SportFragment1";
    private final String tag2 = "com.yijian.workspace.workspace.sport.SportFragment2";
    private final String tag3 = "com.yijian.workspace.workspace.sport.SportFragment3";
