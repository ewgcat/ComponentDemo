...
public class HuiJiFilterDialog extends Dialog {

    private static String TAG = HuiJiFilterDialog.class.getSimpleName();
    ...
    public HuiJiFilterDialog(Activity activity) {
