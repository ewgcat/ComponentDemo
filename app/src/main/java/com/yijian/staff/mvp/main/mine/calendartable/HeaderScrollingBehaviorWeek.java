 ...
 */
public class HeaderScrollingBehaviorWeek extends CoordinatorLayout.Behavior<NestedScrollView> {
    ...
    public HeaderScrollingBehaviorWeek(Context context, AttributeSet attrs) {
        super(context, attrs);
