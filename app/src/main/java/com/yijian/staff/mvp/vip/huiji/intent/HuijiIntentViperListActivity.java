...
public class HuijiIntentViperListActivity extends AppCompatActivity  {
    ...
    private void initVipPeopleList(){
        ...
        try {
            ...
            HuijiIntentViperListAdapter huijiIntentViperListAdapter = new HuijiIntentViperListAdapter(this, viperBeanList);
    ...
    public void initComponent() {
        ...
        BezierRadarHeader header = new BezierRadarHeader(HuijiIntentViperListActivity.this).setEnableHorizontalDrag(true);
        header.setPrimaryColor(Color.parseColor("#1997f8"));
        refreshLayout.setRefreshHeader(header);
        //设置 Footer 为 球脉冲
        BallPulseFooter footer = new BallPulseFooter(HuijiIntentViperListActivity.this).setSpinnerStyle(SpinnerStyle.Scale);
