package com.yijian.staff.mvp.resourceallocation.huijileader.index;
...
import com.yijian.staff.mvp.resourceallocation.huijileader.index.distribution.ResourceAllocationFragment;
import com.yijian.staff.mvp.resourceallocation.huijileader.index.history.HistoryAllocationFragment;
 ...
 * 资源分配(教练总监角色)
 */
@Route(path = "/test/10.3")
public class HuiJiLeaderResourceIndexActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_huiji_leader_resource_allocation);
