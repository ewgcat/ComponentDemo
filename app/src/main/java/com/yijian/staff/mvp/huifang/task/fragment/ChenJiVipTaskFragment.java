...
public class ChenJiVipTaskFragment extends CommonHuiFangTaskFragment {
    ...
    public ChenJiVipTaskFragment() {
        super();
        viewId = R.layout.fragment_chen_ji_list;
    }

    public ChenJiVipTaskFragment(Context context, int type) {
        super(context,  R.layout.fragment_chen_ji_list, type);
