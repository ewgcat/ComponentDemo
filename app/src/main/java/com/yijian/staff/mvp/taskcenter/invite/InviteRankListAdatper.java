 ...
 */
public class InviteRankListAdatper extends RecyclerView.Adapter<InviteRankListAdatper.ViewHolder> {
    private List<RankBean> rankBeanList;
    private Context context;

    public InviteRankListAdatper(Context context, List<RankBean> rankBeanList) {
