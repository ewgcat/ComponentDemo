 ...
 * time: 2018/4/13 19:32:09
 */
public class ExperienceClassProcess5Bean {

    /**
     * 会商结论节点返回对象 {
     conclusionContext (string, optional): 会商结论内容 ,
     recordList (Array[体验课上课记录表返回对象], optional): 上课记录表
     }
     体验课上课记录表返回对象 {
     ...
     * recordList : [{"aerobicsList":[{"contextType":0,"grade":"string","groupNum":0,"groupTime":0,"name":"string","recordContextId":"string","sort":0,"time":0,"weight":0}],"noInstrumentList":[{"contextType":0,"grade":"string","groupNum":0,"groupTime":0,"name":"string","recordContextId":"string","sort":0,"time":0,"weight":0}],"num":0,"powerList":[{"contextType":0,"grade":"string","groupNum":0,"groupTime":0,"name":"string","recordContextId":"string","sort":0,"time":0,"weight":0}],"recordId":"string","templateName":"string"}]
     */
