package com.yijian.staff.mvp.huiji.resourceallocation.fragment.distribution;
 ...
 * 资源分配
 */
public class HuiJiResourceAllocationFragment extends Fragment {

    private static HuiJiResourceAllocationFragment resourceAllocationFragment;
    public static HuiJiResourceAllocationFragment getInstance(){
        if(resourceAllocationFragment == null){
            resourceAllocationFragment = new HuiJiResourceAllocationFragment();
        }
...
//        initResourceAllocationInfoList();
    ...
    private void initView(View view){
        ...
        resourceAllocationAdatper = new HuiJiResourceAllocationAdatper(getActivity(), resourceAllocationInfoList, HuiJiResourceAllocationAdatper.RESOURCE_TYPE);
