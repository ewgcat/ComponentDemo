...
public class HttpManager { 
    ...
    public static void postLogin(LoginRequestBody loginRequestBody, Observer<JSONObject> observer) {
        Observable<JSONObject> loginObservable = apiService.login(HOST + LOGIN_URL, loginRequestBody);
    ...
    public static void postAddCoachHuiFangResult(AddHuiFangResultBody body, Observer<JSONObject> observer) {
        ...
        if (user == null || TextUtils.isEmpty(user.getToken())) {
            ...
            headers.put("token", user.getToken());
            Observable<JSONObject> observable = apiService.postAddHuiFangResult(HOST + POST_COACH_HUI_FANG_RESULT_URL, headers, body);
    ...
    public static void postAddHuiJiHuiFangResult(AddHuiFangResultBody body, Observer<JSONObject> observer) {
        ...
        if (user == null || TextUtils.isEmpty(user.getToken())) {
            ...
            headers.put("token", user.getToken());
            Observable<JSONObject> observable = apiService.postAddHuiFangResult(HOST + POST_HUI_JI_HUI_FANG_RESULT_URL, headers, body);
            execute(observable, observer);
        }
    ...
    public static void getQuestionnaireList(int pageNum, int pageSize, Observer<JSONObject> observer) {
        ...
        if (user == null || TextUtils.isEmpty(user.getToken())) {
            ...
            Observable<JSONObject> observable = apiService.getQuestionnaireList(HOST + GET_QUESTION_NIAR_LIST_URL, headers, body);
    ...
    public static void getCoachVipCourseListList(String memberId, int pageNum, int pageSize, Observer<JSONObject> observer) {
        ...
        if (user == null || TextUtils.isEmpty(user.getToken())) {
            ...
            Observable<JSONObject> loginObservable = apiService.getHasHeaderHasParam(HOST + COACH_PRIVATE_COURSE_STOCK_BASE_INFO_URL, headers, params);
    ...
    public static void getHuiJiInviteRecord(HuiJiInviteListRequestBody body, Observer<JSONObject> observer) {
        ...
        if (user == null || TextUtils.isEmpty(user.getToken())) {
            ...
            headers.put("token", user.getToken());
            Observable<JSONObject> loginObservable = apiService.getHuiJiInviteRecord(HOST + INDEX_HUI_JI_INVITATION_RECORD_URL, headers, body);
    ...
    public static void getHuiJiInviteResult(HuiJiInviteListRequestBody body, Observer<JSONObject> observer) {
        ...
        if (user == null || TextUtils.isEmpty(user.getToken())) {
            ...
            headers.put("token", user.getToken());
            Observable<JSONObject> loginObservable = apiService.getHuiJiInviteRecord(HOST + INDEX_HUI_JI_INVITATION_RESULT_URL, headers, body);
    ...
    public static void getCode(String username, String telephone, Observer<JSONObject> observer) {
        Observable<JSONObject> getCodeObservable = apiService.getCode(HOST + GET_CODE_URL, username, telephone);
    ...
    public static void resetPassword(String username, String telephone, String verificationCode, String newPwd, String confirmPwd, ResultJSONObjectObserver observer) {
        Observable<JSONObject> getCodeObservable = apiService.resetPassword(HOST + RESET_PASSWORD_URL, username, telephone, verificationCode, newPwd, confirmPwd);
        execute(getCodeObservable, observer);
    }
    ...
    public static void getHuiJiAllViperList(Map<String, String> headers, Map<String, Object> params, Observer<JSONObject> observer) {
        Observable<JSONObject> observable = apiService.getDataList(HOST + GET_HUIJI_ALL_VIPER_LIST_URL, headers, params);
        execute(observable, observer);
    }
    ...
    public static void getHuiJiTodayViperList(Map<String, String> headers, Map<String, Object> params, Observer<JSONObject> observer) {
        Observable<JSONObject> observable = apiService.getDataList(HOST + GET_HUIJI_TODAY_VIPER_LIST_URL, headers, params);
        execute(observable, observer);
    }

    //教练 获取全部会员列表
    public static void getCoachAllViperList(Map<String, String> headers, Map<String, Object> params, Observer<JSONObject> observer) {
        Observable<JSONObject> observable = apiService.getDataList(HOST + GET_COACH_ALL_VIPER_LIST_URL, headers, params);
        execute(observable, observer);
    }
    ...
    public static void getCoachTodayViperList(Map<String, String> headers, Map<String, Object> params, Observer<JSONObject> observer) {
        Observable<JSONObject> observable = apiService.getDataList(HOST + GET_COACH_TODAY_VIPER_LIST_URL, headers, params);
        execute(observable, observer);
    }
    ...
    public static void getIndexMenuList(Observer<JSONObject> observer) {
        ...
        if (user == null || TextUtils.isEmpty(user.getToken())) {
            ...
            headers.put("token", user.getToken());
            Observable<JSONObject> observable = apiService.getIndexMenuList(HOST + GET_WORK_INDEX_URL, headers);
            execute(observable, observer);
        }
    }
    ...
    public static void getNewIndexMenuList(Observer<JSONObject> observer) {
        ...
        if (user == null || TextUtils.isEmpty(user.getToken())) {
            ...
            headers.put("token", user.getToken());
            Observable<JSONObject> observable = apiService.getIndexMenuList(HOST + GET_WORK_NEW_MENU_URL, headers);
            execute(observable, observer);
        }
    }
    ...
    public static void postRecptionTest(String memberId, PhysicalExaminationBean physicalExaminationBeanBody, Observer<JSONObject> observer) {
        ...
        if (user == null || TextUtils.isEmpty(user.getToken())) {
            ...
            headers.put("token", user.getToken());
            Observable<JSONObject> receptionTestObservable = apiService.saveReceptionTest(HOST + RECEPTION_TEST_SAVE, headers, memberId, physicalExaminationBeanBody);
    ...
    public static void postRecptionRequstion(String memberId,
        ...
        if (user == null || TextUtils.isEmpty(user.getToken())) {
            ...
            headers.put("token", user.getToken());
            Observable<JSONObject> receptionTestObservable = apiService.postObj(HOST + RECEPTION_QUESTION_SAVE, headers, memberId, requestBody);
            execute(receptionTestObservable, observer);
        }
    }
    ...
    public static void postInvateAgain(InvateBean invateBean, Observer<JSONObject> observer) {
        ...
        if (user == null || TextUtils.isEmpty(user.getToken())) {
            ...
            headers.put("token", user.getToken());
            Observable<JSONObject> receptionTestObservable = apiService.postInvate(HOST + SEND_EXPERICECE_INVITE_HISTORY_URL, headers, invateBean);
            execute(receptionTestObservable, observer);
        }
    }
    ...
    public static void saveMenuChange(MenuRequestBody menuRequestBody, Observer<JSONObject> observer) {
        ...
        if (user == null || TextUtils.isEmpty(user.getToken())) {
            ...
            headers.put("token", user.getToken());
            Observable<JSONObject> observable = apiService.saveMenuChange(HOST + SAVE_MENU_CHANGE_URL, headers, menuRequestBody);
            execute(observable, observer);
        }
    }
    ...
    public static void getCoachPrivateCourseList(CoachPrivateCourseRequestBody body, Observer<JSONObject> observer) {
        ...
        if (user == null || TextUtils.isEmpty(user.getToken())) {
            ...
            headers.put("token", user.getToken());
            Observable<JSONObject> observable = apiService.getCoachPrivateCourseList(HOST + COACH_PRIVATE_COURSE_LIST_URL, headers, body);
            execute(observable, observer);
        }
    }
    ...
    public static void getHuiJiCardGoodsList_ycm(ConditionBody body, Observer<JSONObject> observer) {
        ...
        if (user == null || TextUtils.isEmpty(user.getToken())) {
            ...
            Observable<JSONObject> observable = apiService.getHuiJiCardGoodsList_ycm(HOST + HUI_JI_CARD_GOODS_LIST_URL, headers, body);
            execute(observable, observer);
        }
    }
    ...
    public static void getHuiJiCardGoodsList(CardRequestBody body, Observer<JSONObject> observer) {
        ...
        if (user == null || TextUtils.isEmpty(user.getToken())) {
            ...
            Observable<JSONObject> observable = apiService.getHuiJiCardGoodsList(HOST + HUI_JI_CARD_GOODS_LIST_URL, headers, body);
            execute(observable, observer);
        }
    }
    ...
    public static void searchViperByCoach(Map<String, String> params, Observer<JSONObject> observer) {
        ...
        getHasHeaderHasParam(HOST + INDEX_COACH_QUERY_URL, params, observer);
    ...
    public static void searchViperByHuiJi(Map<String, String> params, Observer<JSONObject> observer) {
        ...
        getHasHeaderHasParam(HOST + INDEX_HUI_JI_QUERY_URL, params, observer);
    ...
    public static void postEditHuiJiVipInfo(String url, EditHuiJiVipBody editHuiJiVipBody, Observer<JSONObject> observer) {
        ...
        if (user == null || TextUtils.isEmpty(user.getToken())) {
            ...
            headers.put("token", user.getToken());
            Observable<JSONObject> observable = apiService.editHuiJiVipDetail(HOST + url, headers, editHuiJiVipBody);
            execute(observable, observer);
        }
    }
    ...
    public static void postXiaKeRecord(String url, PrivateShangKeBean privateShangKeBean, String state, Observer<JSONObject> observer) {
        ...
        if (user == null || TextUtils.isEmpty(user.getToken())) {
            ...
            headers.put("token", user.getToken());
            Observable<JSONObject> observable = apiService.saveXiaKeRecord(HOST + url, headers, privateShangKeBean, state);
            execute(observable, observer);
        }
    }
    ...
    public static void postAddAdvice(String url, AddAdviceBody addAdviceBody, Observer<JSONObject> observer) {
        ...
        if (user == null || TextUtils.isEmpty(user.getToken())) {
            ...
            headers.put("token", user.getToken());
            Observable<JSONObject> observable = apiService.postAddAdvice(HOST + url, headers, addAdviceBody);
            execute(observable, observer);
        }
    }
    ...
    public static void savePrivatePrepareLesson(String url, PrivatePrepareLessonBody privatePrepareLessonBody, Observer<JSONObject> observer) {
        ...
        User user = DBManager.getInstance().queryUser();
        headers.put("token", user.getToken());
        Observable<JSONObject> observable = apiService.savePrivatePrepareLesson(HOST + url, headers, privatePrepareLessonBody);
        execute(observable, observer);
    }
    ...
    public static void postExperienceAccessRecord(String url, AccessRecordBean recordBean, Observer<JSONObject> observer) {
        ...
        headers.put("token", user.getToken());
        Observable<JSONObject> observable = apiService.postExperienceAccessRecord(HOST + url, headers, recordBean);
        execute(observable, observer);
    }
    ...
    public static void postNoHeaderNoParam(String url, Observer<JSONObject> observer) {
        Observable<JSONObject> observable = apiService.postNoHeaderNoParam(HOST + url);
        execute(observable, observer);
    }
    ...
    public static void postHasHeaderNoParam(String url, Observer<JSONObject> observer) {
        ...
        if (user == null || TextUtils.isEmpty(user.getToken())) {
            ...
            Observable<JSONObject> observable = apiService.postHasHeaderNoParam(HOST + url, headers);
            execute(observable, observer);
        }
    }
    ...
    public static void postNoHeaderHasParam(String url, Map<String, String> param, Observer<JSONObject> observer) {
        Observable<JSONObject> observable = apiService.postNoHeaderHasParam(HOST + url, param);
        execute(observable, observer);
    }
    ...
    public static void postHasHeaderHasParam(String url, Map<String, String> param, Observer<JSONObject> observer) {
        ...
        if (user == null || TextUtils.isEmpty(user.getToken())) {
            ...
            headers.put("token", user.getToken());
            Observable<JSONObject> observable = apiService.postHasHeaderHasParam(HOST + url, headers, param);
            execute(observable, observer);
        }
    }
    ...
    public static void postHasHeaderHasParamOfObject(String url, Map<String, Object> param, Observer<JSONObject> observer) {
        ...
        if (user == null || TextUtils.isEmpty(user.getToken())) {
            ...
            headers.put("token", user.getToken());
            Observable<JSONObject> observable = apiService.postHasHeaderHasParamOfObject(HOST + url, headers, param);
            execute(observable, observer);
        }
    }
    ...
    public static void postHasHeaderHasParamOfInteger(String url, Map<String, Integer> param, Observer<JSONObject> observer) {
        ...
        if (user == null || TextUtils.isEmpty(user.getToken())) {
            ...
            headers.put("token", user.getToken());
            Observable<JSONObject> observable = apiService.postHasHeaderHasParamOfInteger(HOST + url, headers, param);
            execute(observable, observer);
        }
    ...
    public static void getNoHeaderNoParam(String url, Observer<JSONObject> observer) {
        Observable<JSONObject> observable = apiService.getNoHeaderNoParam(HOST + url);
        execute(observable, observer);
    }
    ...
    public static void getHasHeaderNoParam(String url, Observer<JSONObject> observer) {
        ...
        if (user == null || TextUtils.isEmpty(user.getToken())) {
            ...
            headers.put("token", user.getToken());
            Observable<JSONObject> observable = apiService.getHasHeaderNoParam(HOST + url, headers);
            execute(observable, observer);
        }
    }
    ...
    public static void getNoHeaderHasParam(String url, Map<String, String> param, Observer<JSONObject> observer) {
        Observable<JSONObject> observable = apiService.getNoHeaderHasParam(HOST + url, param);
        execute(observable, observer);
    }
    ...
    public static void getHasHeaderHasParamOfObject(String url, Map<String, Object> param, Observer<JSONObject> observer) {
        ...
        if (user == null || TextUtils.isEmpty(user.getToken())) {
            ...
            headers.put("token", user.getToken());
            Observable<JSONObject> observable = apiService.getHasHeaderHasObjectParam(HOST + url, headers, param);
            execute(observable, observer);
        }
    }
    ...
    public static void getBusinessMessage(BusinessMessageRequestBody businessMessageRequestBody, Observer<JSONObject> observer) {
        ...
        if (user == null || TextUtils.isEmpty(user.getToken())) {
            ...
            headers.put("token", user.getToken());
            Observable<JSONObject> observable = apiService.getBusinessMessage(HOST + GET_BUSINESS_MESSAGE_URL, headers, businessMessageRequestBody);
            execute(observable, observer);
        }
    }
