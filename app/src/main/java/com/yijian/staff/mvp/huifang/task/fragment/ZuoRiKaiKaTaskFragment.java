...
public class ZuoRiKaiKaTaskFragment extends CommonHuiFangTaskFragment {
    ...
    public ZuoRiKaiKaTaskFragment() {
        super();
        viewId = R.layout.fragment_zuo_ri_kai_ka_list;
    }

    public ZuoRiKaiKaTaskFragment(Context context, int type) {
        super(context,  R.layout.fragment_zuo_ri_kai_ka_list, type);
