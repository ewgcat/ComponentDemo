package com.yijian.staff.mvp.huifang.coach.task;
...
import com.yijian.staff.mvp.huifang.coach.history.CoachHuiFangHistoryActivity;
import com.yijian.staff.mvp.huifang.coach.task.fragment.CoachBaseHuiFangTaskFragment;
import com.yijian.staff.mvp.huifang.coach.task.pageadapter.CoachHuiFangPagerAdapter;
...
public class CoachHuiFangTaskActivity extends MvcBaseActivity {
    ...
    private void initData() {
        HttpManager.getHasHeaderNoParam(HttpManager.GET_COACH_HUI_FANG_TYPE_LIST_URL, new ResultJSONObjectObserver(getLifecycle()) {
            @Override
    ...
    public void updateAllNoticeNum() {
        ...
        params.put("type", "0");
        HttpManager.getHasHeaderHasParam(HttpManager.GET_COACH_HUI_FANG_TASK_URL, params, new ResultJSONObjectObserver(getLifecycle()) {
            @Override
            public void onSuccess(JSONObject result) {
