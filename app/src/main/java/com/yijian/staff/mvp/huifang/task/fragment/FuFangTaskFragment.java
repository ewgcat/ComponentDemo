...
public class FuFangTaskFragment extends CommonHuiFangTaskFragment {
    ...
    public FuFangTaskFragment() {
        super();
        viewId = R.layout.fragment_fu_fang;
    }

    public FuFangTaskFragment(Context context, int type) {
        super(context,  R.layout.fragment_fu_fang, type);
