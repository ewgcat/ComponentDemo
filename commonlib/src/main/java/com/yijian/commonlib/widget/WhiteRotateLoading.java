...
public class WhiteRotateLoading extends View {
    ...
    public WhiteRotateLoading(Context context) {
        super(context);
        initView(context, null);
    }

    public WhiteRotateLoading(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public WhiteRotateLoading(Context context, AttributeSet attrs, int defStyleAttr) {
