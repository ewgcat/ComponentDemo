package com.yijian.staff.mvp.course.cunke.bean;
...
public class TypeOfCunKeTitle {
    ...
    public TypeOfCunKeTitle(String userName, String lessonName, String totalLessonNum, String remainLessonNum) {
