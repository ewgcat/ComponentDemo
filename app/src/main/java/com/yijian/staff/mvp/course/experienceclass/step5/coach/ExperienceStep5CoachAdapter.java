...
public class ExperienceStep5CoachAdapter extends RecyclerView.Adapter<ExperienceStep5CoachAdapter.Holder> {
    ...
    @Override
    public ExperienceStep5CoachAdapter.Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_experience_step5, parent, false);
    ...
    @Override
    public void onBindViewHolder(ExperienceStep5CoachAdapter.Holder holder, int position) {
