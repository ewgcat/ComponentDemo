...
public abstract class ExpandableRecyclerAdapter<P extends Parent<C>, C, PVH extends ParentViewHolder, CVH extends ChildViewHolder>
    ...
    private ParentViewHolder.ParentViewHolderExpandCollapseListener mParentViewHolderExpandCollapseListener = new ParentViewHolder.ParentViewHolderExpandCollapseListener() {
         ...
         *
         * @param flatParentPosition The index of the item_curriculum in the list being expanded, relative to the flattened list
         */
        @Override
        @UiThread
         ...
         *
         * @param flatParentPosition The index of the item_curriculum in the list being collapsed, relative to the flattened list
         */
        @Override
        @UiThread
    ...
    /**
     * Collapses a specified parent item_curriculum. Calls through to the
     ...
     * This will also trigger an item_curriculum changed for children of the parent list specified.
     * <p>
     * This is an item_curriculum change event, not a structural change event. It indicates that any
     ...
     *
     * @param parentPosition Position of the item_curriculum that has changed
     */
    @UiThread
     ...
     * at {@code parentPositionStart} have changed. This will also trigger an item_curriculum changed
     ...
     *
     * @param parentPositionStart Position of the item_curriculum that has changed
    ...
    /**
     * Notify any registered observers that the parent reflected at {@code parentPosition}
     * has a child list item_curriculum that has been newly inserted at {@code childPosition}.
     * The child list item_curriculum previously at {@code childPosition} is now at
     ...
     * The child list item_curriculum previously at {@code childPositionStart} and beyond are now at
     ...
     * The child list item_curriculum previously located at and after {@code childPosition} may
    ...
    /**
     * Notify any registered observers that the child list item_curriculum contained within the parent
    ...
    /**
     * Gets the index of a ExpandableWrapper within the helper item_curriculum list based on
