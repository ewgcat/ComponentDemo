...
public class KuaiOutdateTaskFragment extends CommonHuiFangTaskFragment {
    ...
    public KuaiOutdateTaskFragment() {
        super();
        viewId = R.layout.fragment_kuai_outdate_list;
    }

    public KuaiOutdateTaskFragment(Context context, int type) {
        super(context,  R.layout.fragment_all_hui_fang_list, type);
