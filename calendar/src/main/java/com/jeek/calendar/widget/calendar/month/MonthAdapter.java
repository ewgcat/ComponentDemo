...
//        Log.e(TAG, "getYearAndMonth: time="+time );
        time = time.plusMonths(position - mMonthCount / 2);
//        Log.e(TAG, "getYearAndMonth: timeplusMonths="+time );
        date[0] = time.getYear();
//        Log.e(TAG, "getYearAndMonth:time.getYear() =="+date[0] );
        date[1] = time.getMonthOfYear() - 1;
//        Log.e(TAG, "getYearAndMonth:time.getMonthOfYear() =="+date[1] );
        return date;
    }
