package com.yijian.staff.mvp.huifang.coach.history;
...
public class CoachHuiFangHistoryAdapter extends RecyclerView.Adapter<CoachHuiFangHistoryAdapter.ViewHolder> {
    ...
    public CoachHuiFangHistoryAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_coach_hui_fang_history, parent, false);
        CoachHuiFangHistoryAdapter.ViewHolder holder = new CoachHuiFangHistoryAdapter.ViewHolder(view);
        return holder;
    }
    ...
    public void onBindViewHolder(CoachHuiFangHistoryAdapter.ViewHolder holder, int position) {
        ...
        String interviewResult = coachHuiFangInfo.getInterviewResult();
    ...
    private void resetView(CoachHuiFangHistoryAdapter.ViewHolder holder) {
