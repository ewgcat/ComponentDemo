...
public class NewCourseItemView extends LinearLayout {
    ...
    //存储的是当前正在展开的View
    private static NewCourseItemView mViewCache;
    ...
    public NewCourseItemView(Context context) {
        this(context, null);
    }

    public NewCourseItemView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NewCourseItemView(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @param ios
     */
    public NewCourseItemView setIos(boolean ios) {
        isIos = ios;
        return this;
    }
     ...
     * @return
     */
    public NewCourseItemView setLeftSwipe(boolean leftSwipe) {
     ...
     * @return
     */
    public static NewCourseItemView getViewCache() {
        return mViewCache;
    }
...
/*                    if (!mScroller.isFinished()) {
    ...
    public void smoothExpand() {
        ...
        invalidate();*/
        //展开就加入ViewCache：
        mViewCache = NewCourseItemView.this;
...
/*        mScroller.startScroll(getScrollX(), 0, -getScrollX(), 0);
        ...
        mCloseAnim.setDuration(1).start();
