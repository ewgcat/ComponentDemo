...
import com.yijian.clubmodule.ui.huifang.vip.task.adapter.HuiFangTaskAdapter.ViewHolder
import com.yijian.clubmodule.ui.huifang.vip.tianxieresult.TianXieHuiFangResultActivity
 ...
 */
class HuiFangTaskAdapter(private val context: Context, private var mHuiFangInfoList: List<HuiFangInfo>?, private val menu: Int) : RecyclerView.Adapter<HuiFangTaskAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_hui_fang_task, parent, false)
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        var tvHuifangJilu: TextView? = null
        var tvYaoyueJilu: TextView? = null
        ...
        fun bindView(context: Context, huiFangInfo: HuiFangInfo) {
            ...
            if (status == 2) {
                if (!TextUtils.isEmpty(reviewReason)) {
                    ...
                    tvHuifangType.text = huiFangInfo.interviewName!! + " ( 复访 ）"
                }
            }


            llBt.setOnClickListener {
                val mobile = huiFangInfo.mobile
                if (!TextUtils.isEmpty(mobile)) {
                    if (CommonUtil.isPhoneFormat(mobile)) {
                        val i = Intent(context, TianXieHuiFangResultActivity::class.java)
            ...
            if (memberQuietInterview != null) {
                ...
                tvZuijinJianshen.text = lastTime
            ...
            if (studentPrivateCoursePastDueInterview != null) {
                ...
                tvOutdateTime.text = nullCovertToPlaceHolder(studentPrivateCoursePastDueInterview.endTime)
            }
