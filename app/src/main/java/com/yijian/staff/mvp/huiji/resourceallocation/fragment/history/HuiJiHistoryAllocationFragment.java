package com.yijian.staff.mvp.huiji.resourceallocation.fragment.history;
 ...
 * 历史分配
 */
public class HuiJiHistoryAllocationFragment extends Fragment {

    private static  HuiJiHistoryAllocationFragment historyAllocationFragment;
    public static HuiJiHistoryAllocationFragment getInstance(){
        if(historyAllocationFragment == null){
            historyAllocationFragment = new HuiJiHistoryAllocationFragment();
        }
...
//        initResourceAllocationInfoList();
    ...
    private void initView(View view){
        ...
        resourceAllocationAdatper = new HuiJiResourceAllocationAdatper(getActivity(), resourceAllocationInfoList, HuiJiResourceAllocationAdatper.HISTORY_TYPE);
