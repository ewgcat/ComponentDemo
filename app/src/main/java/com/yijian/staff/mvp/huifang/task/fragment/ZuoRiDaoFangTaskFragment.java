...
public class ZuoRiDaoFangTaskFragment extends CommonHuiFangTaskFragment {
    ...
    public ZuoRiDaoFangTaskFragment() {
        super();
        viewId = R.layout.fragment_zuo_ri_dao_fang_list;
    }

    public ZuoRiDaoFangTaskFragment(Context context, int type) {
        super(context,  R.layout.fragment_zuo_ri_dao_fang_list, type);
    ...
    public void refresh(boolean isShowLoading) {
        ...
        try {
            ...
            jsonObject.put("huifangType","昨日到访");
